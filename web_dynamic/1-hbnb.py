#!/usr/bin/python3
"""
This Flask application dynamically generates an HTML page that
includes dropdown menus for locations (states/cities) and amenities,
along with listings for rentals.
"""
...
# Disable strict slashes in URL routing to allow both trailing
...
def display_hbnb():
    """
    This function generates a webpage with dropdown menus for states
    and cities, amenities, and places available for rent.
...
if __name__ == '__main__':
    ...
    It starts the web server on all network interfaces (0.0.0.0) and listens
    on port 5000.
    """
